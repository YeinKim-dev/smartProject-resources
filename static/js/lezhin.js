if(!window['lezhin']) {
    ...
    _O.Ctrl = {
      getLists() {
        return [
          {
            name: '김지훈',
            imgSrc: '/images/man/01.jpg',
            selected: false
          },
          {
            name: '남주혁',
            imgSrc: '/images/man/02.jpg',
            selected: false
          },
          {
            name: '뷔',
            imgSrc: '/images/man/03.jpg',
            selected: false
          },
          {
            name: '이준혁',
            imgSrc: '/images/man/04.jpg',
            selected: false
          },
          {
            name: '김수현',
            imgSrc: '/images/man/05.jpg',
            selected: false
          },
          {
            name: '박서준',
            imgSrc: '/images/man/06.jpg',
            selected: false
          },
          {
            name: '정해인',
            imgSrc: '/images/man/07.jpg',
            selected: false
          },
          {
            name: '차은우',
            imgSrc: '/images/man/08.jpg',
            selected: false
          },
          {
            name: '강동원',
            imgSrc: '/images/man/09.jpg',
            selected: false
          },
          {
            name: '고수',
            imgSrc: '/images/man/10.jpg',
            selected: false
          },
          {
            name: '이진욱',
            imgSrc: '/images/man/11.jpg',
            selected: false
          },
          {
            name: '송강',
            imgSrc: '/images/man/12.jpg',
            selected: false
          },
          {
            name: '우도환',
            imgSrc: '/images/man/13.jpg',
            selected: false
          },
          {
            name: '김민석',
            imgSrc: '/images/man/14.jpg',
            selected: false
          },
          {
            name: '임시완',
            imgSrc: '/images/man/15.jpg',
            selected: false
          },
          {
            name: '이도현',
            imgSrc: '/images/man/16.jpg',
            selected: false
          }
        ];
      },
    ...
    _O.Html = {
      ...
      setRoundTitle() {
        ...
        else document.getElementById('roundTitle').innerText = `이상형에게 
        시그널이 보내졌어요♥`;
      },
      setItem() {
